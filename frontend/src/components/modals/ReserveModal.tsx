...
export function ReserveModal({
  ...
  // Form State
  const [identityMode, setIdentityMode] = useState<"REGISTERED" | "GUEST">(
    "REGISTERED",
  );
  ...
  const extrasTotal = useMemo(
    () =>
      extras
        .filter((e) => e.selected)
        .reduce((acc, curr) => acc + safeCurrency(curr.price), 0),
    [extras],
  );
  ...
  const toggleExtra = (id: string) => {
    setExtras(
      extras.map((e) => (e.id === id ? { ...e, selected: !e.selected } : e)),
    );
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const endDateTime = new Date(
        startDateTime.getTime() + totalHours * 60 * 60 * 1000,
      );

      const isSelf =
        currentMode === "user" ||
        (identityMode === "REGISTERED" && !targetUser);
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs font-bold text-gray-400 uppercase tracking-widest">
                Unit #{bike?.code || "New Selection"} •{" "}
                {bike?.station?.name || "León Central"}
              </span>
            </div>
          </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 font-medium">
                  Select an existing customer or register a new guest
                </p>
              </div>
            </div>
            ...
            {identityMode === "REGISTERED" ? (
              <div className="space-y-6">
                <div className="relative group">
                  ...
                  />
                  {searching && (
                    <div className="absolute right-6 top-1/2 -translate-y-1/2 animate-spin rounded-full h-6 w-6 border-2 border-black border-t-transparent" />
                  )}
                </div>
                  ...
                  <div className="max-h-72 overflow-y-auto border-2 border-gray-100 rounded-[2rem] divide-y-2 divide-gray-50 shadow-xl bg-white">
                    {searchResults.map((u, index) => (
                      <div
                        ...
                        className={cn(
                          "p-6 cursor-pointer flex justify-between items-center group transition-all duration-200",
                          selectedIndex === index
                            ? "bg-black text-white"
                            : "hover:bg-gray-50",
                        )}
                      >
                        <div className="flex items-center gap-4">
                          <div
                            className={cn(
                              "w-14 h-14 rounded-2xl flex items-center justify-center font-black transition-all text-xl",
                              selectedIndex === index
                                ? "bg-white text-black"
                        ...
                        <Plus
                          size={24}
                          className="text-gray-300 group-hover:text-black group-hover:scale-125 transition-all"
                        />
                      </div>
                    ))}
                  </div>
                ...
                {targetUser && (
                  <div className="bg-blue-50 border-2 border-blue-100 p-8 rounded-[2.5rem] flex items-center gap-8 animate-in zoom-in-95 shadow-lg shadow-blue-100">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-blue-700 font-bold opacity-80 mt-1">
                        {targetUser.documentType}: {targetUser.documentNumber}
                      </p>
                    </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="md:col-span-2 space-y-3">
                  ...
                  <Input
                    ...
                    className="h-20 rounded-[1.5rem] bg-gray-50 border-gray-200 focus:bg-white text-xl px-8 font-bold"
                    value={guestName}
          ...
          <div className="space-y-10 animate-in fade-in slide-in-from-right-4 duration-300">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 font-medium">
                  Set when the rental starts and for how long
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-3">
                ...
                <Input
                  ...
                  className="h-20 rounded-[1.5rem] bg-gray-50 border-gray-200 text-xl font-black px-8"
                />
              </div>
              <div className="space-y-3">
                <label className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] ml-2">
            ...
            <div className="p-12 bg-gray-50 rounded-[3.5rem] border-2 border-gray-100 shadow-inner">
              <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.3em] mb-10 text-center">
              ...
              <div className="flex items-center justify-center gap-10">
                <div className="flex flex-col items-center">
                  ...
                  />
                  <p className="text-[10px] font-black text-gray-500 uppercase mt-6 tracking-[0.2em]">
                    Days
                  </p>
                </div>
          ...
          <div className="space-y-10 animate-in fade-in slide-in-from-right-4 duration-300">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 font-medium">
                  Customize rates and include additional services
                </p>
              </div>
            </div>
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-500 font-bold">
                    Base rate for this specific rental
                  </p>
                </div>
                  ...
                  {currentMode === "admin" ? (
                    <div className="relative">
                      ...
                      <Input
                        ...
                        value={ratePerHour}
                        onChange={(e) =>
                          setRatePerHour(parseInt(e.target.value) || 0)
                        }
                    ...
                    <div>
                      <p
                        className={cn(
                          ...
                          extra.selected ? "text-emerald-900" : "text-gray-900",
                        )}
                      >
                        {extra.name}
                      </p>
          ...
          <div className="space-y-10 animate-in fade-in slide-in-from-right-4 duration-300">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 font-medium">
                  Review the final details and select payment method
                </p>
              </div>
            </div>
                  ...
                  <div className="flex justify-between items-center text-base pt-4 border-t border-white/10">
                    ...
                    <span className="font-black text-2xl">
                      ...
                      {paymentOption === "FULL"
                        ? "0.00"
                        : paymentOption === "DEPOSIT"
                          ? formatCurrency(totalCost - depositCost)
                          : formatCurrency(totalCost)}
                    </span>
                  </div>
                </div>
                    ...
                    >
                      <div className="flex items-center gap-5">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-gray-500 uppercase font-black tracking-wider opacity-60">
                            {opt.desc}
                          </p>
                        </div>
                      </div>
                      <div className="text-right">
                        ...
                        {paymentOption === opt.id && (
                          <div className="h-2 w-full bg-black rounded-full mt-2 animate-in slide-in-from-right-full duration-500" />
                        )}
                      </div>
                    </div>
                  ))}
            ...
            {paymentOption === "LATER" && (
              <div className="bg-amber-50 border-2 border-amber-100 p-8 rounded-[2.5rem] flex gap-6 items-start animate-in slide-in-from-bottom-4 shadow-lg shadow-amber-100/50">
                ...
                <div>
                  <p className="text-xs font-black text-amber-900 uppercase tracking-[0.2em] mb-2">
                    Temporary Hold Policy
                  </p>
                  <p className="text-base text-amber-800 font-bold leading-relaxed">
                    The bike will be held for exactly{" "}
                    <strong className="font-black text-amber-950 underline decoration-amber-300 underline-offset-4">
                      15 minutes
                    </strong>
                    . If not paid or checked-in by then, the system will
                    auto-release the unit.
                  </p>
                </div>
              </div>
            )}
          ...
          {step < 4 ? (
            <Button
              ...
              disabled={
                step === 1 &&
                ((identityMode === "REGISTERED" && !targetUser) ||
                  (identityMode === "GUEST" && (!guestName || !guestDoc)))
              }
